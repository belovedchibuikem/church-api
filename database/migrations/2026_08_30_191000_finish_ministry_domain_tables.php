...
return new class extends Migration
{
    public function up(): void
    {
        ...
        } elseif (! $this->hasIndex('home_church_attendance_records', 'hc_attendance_church_date_unique')) {
    ...
    {
        // Intentionally empty: companion finish migration for a partially applied schema.
    }
