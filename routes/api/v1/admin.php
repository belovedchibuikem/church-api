...
Route::prefix('kca')->name('kca.')->controller(KcaOperationsController::class)->group(function (): void {
    ...
    Route::get('/enrollments/{enrollment}', 'showEnrollment')->whereUlid('enrollment')->middleware(RequirePermissionAndScope::class.':kca.enrollments.view')->name('enrollments.show');
    Route::patch('/enrollments/{enrollment}', 'updateEnrollment')->whereUlid('enrollment')->middleware(RequirePermissionAndScope::class.':kca.enrollments.manage')->name('enrollments.update');
    Route::delete('/enrollments/{enrollment}', 'destroyEnrollment')->whereUlid('enrollment')->middleware(RequirePermissionAndScope::class.':kca.enrollments.manage')->name('enrollments.destroy');
    ...
    Route::post('/assessment-results', 'recordAssessmentResults')->middleware(RequirePermissionAndScope::class.':kca.assessments.record')->name('assessment_results.store');
    ...
    Route::post('/applications/bulk-transitions', 'bulkTransitionApplications')->middleware(RequirePermissionAndScope::class.':kca.applications.transition')->name('applications.bulk_transitions.store');
    Route::post('/applications/bulk-enrollments', 'bulkAdmitStudents')->middleware(RequirePermissionAndScope::class.':kca.enrollments.manage')->name('applications.bulk_enrollments.store');
