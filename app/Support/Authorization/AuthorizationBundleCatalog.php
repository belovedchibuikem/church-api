    ...
    public const BUNDLES = [
        ...
        self::PLATFORM_ADMINISTRATOR_ROLE => [
            ...
            'permissions' => [
                ...
                'administration.work_items.view',
                'administration.work_items.manage',
        ...
        self::DOMAIN_OPERATIONS_ADMINISTRATOR_ROLE => [
            ...
            'permissions' => [
                ...
                'finance.payment_reconciliations.manage',
                'finance.payment_receipts.issue',
